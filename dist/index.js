...
var Dropdown =
  ...
  (function(_Component) {
    ...
    function Dropdown(props) {
      ...
      _this.mounted = true;
      _this.handleDocumentClick = _this.handleDocumentClick.bind(
        _assertThisInitialized(_this)
      );
      _this.fireChangeEvent = _this.fireChangeEvent.bind(
        _assertThisInitialized(_this)
      );
      return _this;
    }
    ...
    _createClass(Dropdown, [
      ...
      },
      {
        ...
        value: function renderOption(
          ...
          _defineProperty(_classes, ''.concat(customOptionClass), true),
          _defineProperty(_classes, option.className, !!option.className),
          _defineProperty(
            _classes,
            ''.concat(customOptionSelectedClass),
            isSelected
          ),
          _classes);
        ...
        value: function buildMenu(
          ...
          var ops = options.map(function(option) {
            if (option.type === 'group') {
              var groupTitle = _react['default'].createElement(
                'div',
                {
      ...
      },
      {
        ...
        value: function handleDocumentClick(event) {
          if (this.mounted) {
            if (
              !_reactDom['default'].findDOMNode(this).contains(event.target)
            ) {
      ...
      },
      {
        ...
        value: function render() {
          ...
          var _this$props2 = this.props,
            ...
            optionClassName = _this$props2.optionClassName,
            optionSelectedClassName = _this$props2.optionSelectedClassName,
          ...
          var dropdownClass = (0, _classnames['default'])(
            ...
            _defineProperty(
              _classNames,
              ''.concat(baseClassName, '-root'),
              true
            ),
            _defineProperty(_classNames, className, !!className),
            _defineProperty(_classNames, 'is-open', this.state.isOpen),
            _classNames)
          );
          var controlClass = (0, _classnames['default'])(
            ((_classNames2 = {}),
            _defineProperty(
              _classNames2,
            ...
            _defineProperty(_classNames2, controlClassName, !!controlClassName),
            _defineProperty(_classNames2, disabledClass, !!disabledClass),
            _classNames2)
          );
          var placeholderClass = (0, _classnames['default'])(
            ...
            _defineProperty(
              _classNames3,
              ''.concat(baseClassName, '-placeholder'),
              true
            ),
            _defineProperty(
              _classNames3,
          ...
          var menuClass = (0, _classnames['default'])(
            ((_classNames4 = {}),
            _defineProperty(
              _classNames4,
              ''.concat(baseClassName, '-menu'),
              true
            ),
            _defineProperty(_classNames4, menuClassName, !!menuClassName),
            _classNames4)
          );
          var arrowClass = (0, _classnames['default'])(
            ...
            _defineProperty(
              _classNames5,
              ''.concat(baseClassName, '-arrow'),
              true
            ),
            _defineProperty(_classNames5, arrowClassName, !!arrowClassName),
            _classNames5)
          );
          var customOptionClass = (0, _classnames['default'])(
            ((_classNames6 = {}),
            _defineProperty(
              _classNames6,
              ''.concat(baseClassName, '-option'),
              true
            ),
            _defineProperty(_classNames6, optionClassName, !!optionClassName),
            _classNames6)
          );

          var customOptionSelectedClass = (0, _classnames['default'])(
            ((_classNames7 = {}),
            _defineProperty(
              _classNames7,
              ''.concat(optionClassName, '-selected'),
              true
            ),
            _defineProperty(
              _classNames7,
          ...
          var menu = this.state.isOpen
            ? _react['default'].createElement(
                ...
                this.buildMenu(customOptionClass, customOptionSelectedClass)
              )
            : null;
          return _react['default'].createElement(
            'div',
